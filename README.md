...
![screenshot](Animation.gif)<img src="demo.gif" width="200">
## What is this?
...
2. [Click here to install](https://raw.githubusercontent.com/nugget5600x/miku-x-blocker/main/miku.user.js) to install the script
3. Visit X (Twitter) and Miku will appear! 🎵

## Requirements
- Tampermonkey compatible browser (Chrome, Firefox, etc.)
